...
HD_PWD='C:/Users/ktzam/Downloads/sincos/sincos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sincos.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sincos.tcl
