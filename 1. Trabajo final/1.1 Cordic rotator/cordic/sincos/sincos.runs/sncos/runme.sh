...
HD_PWD='C:/Users/ktzam/Downloads/sincos/sincos.runs/sncos'
cd "$HD_PWD"
...
EAStep vivado -log sincos.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sincos.tcl -notrace
