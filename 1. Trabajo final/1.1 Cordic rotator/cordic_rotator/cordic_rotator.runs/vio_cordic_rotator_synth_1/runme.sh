...
HD_PWD='C:/Users/ktzam/Downloads/CIRCUITOS LOGICO/20042024/cordic_rotator/cordic_rotator.runs/vio_cordic_rotator_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_cordic_rotator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_cordic_rotator.tcl
