...
HD_PWD='C:/Users/ktzam/Downloads/CIRCUITOS LOGICO/20042024/cordic_rotator/cordic_rotator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_cordic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vio_cordic.tcl -notrace
