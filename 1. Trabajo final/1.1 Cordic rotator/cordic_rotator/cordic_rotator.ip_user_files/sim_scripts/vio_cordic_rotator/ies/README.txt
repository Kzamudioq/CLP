...
#
# Generated by export_simulation on Tue Apr 23 14:08:41 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './vio_cordic_rotator.sh' script.

./vio_cordic_rotator.sh -reset_run
...
./vio_cordic_rotator.sh -noclean_files

For more information on the script, please type './vio_cordic_rotator.sh -help'.
